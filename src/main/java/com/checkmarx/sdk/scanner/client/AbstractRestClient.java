...
import com.checkmarx.sdk.utils.HttpClientHelper;
...
public abstract class AbstractRestClient {
   ...
   // protected static final PropertyFileLoader properties = PropertyFileLoader.getDefaultInstance();
    ...
    protected HttpResponse submitSourcesFromRemoteRepo(AstScaConfig config, String projectId) throws IOException {
