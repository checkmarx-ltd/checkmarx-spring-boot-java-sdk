...
@Service
@Slf4j
public class FilterValidatorGo {
    /**
     ...
     */
    public boolean passesFilter(@NotNull FilterInputGo finding, EngineFilterConfiguration filterConfiguration) {
        boolean result;
    ...
    private static boolean passesScriptedFilter(FilterInputGo finding, EngineFilterConfiguration filterConfiguration) {
    ...
    private boolean passesSimpleFilter(FilterInputGo finding, EngineFilterConfiguration filterConfiguration) {
    ...
    private boolean findingPassesFilter(FilterInputGo finding, List<Filter> filters) {
    ...
    private static void rethrowWithDetailedMessage(GroovyRuntimeException cause) {
        List<String> existingFields = Arrays.stream(FilterInputGo.class.getDeclaredFields())
                .map(Field::getName)
    ...
    private static void logFilteringResult(FilterInputGo finding, boolean passes) {
