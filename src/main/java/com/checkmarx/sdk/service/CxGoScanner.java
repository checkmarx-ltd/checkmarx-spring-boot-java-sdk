...
import com.checkmarx.sdk.scanner.client.ILegacyClient;
...
@Service
@Slf4j
public class CxGoScanner implements ILegacyClient {
    ...
    public CxGoScanner(CxGoProperties cxProperties, CxGoAuthService authClient,
